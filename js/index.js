...
$(function() {
	...
	function datapower(offset) {
	  var ret = [];
	  for (var x = 20; x <= 27; x++) {
		//var v = (offset + x) % 360;
		ret.push({
		  x: x,
		  y: Math.floor(5100 - Math.random()*(5100-4900)),
		  //y: 5000,
		});
	  }
	  return ret;
	...
	function datacooling(offset) {
	  var ret = [];
	  for (var x = 20; x <= 27; x++) {
		//var v = (offset + x) % 360;
		ret.push({
		  x: x,
		  y: Math.floor(2400 - Math.random()*(2400-2000)),
		  //y: 5000,
		});
	  }
	  return ret;
	...
	function dataspace(offset) {
	  var ret = [];
	  for (var x = 20; x <= 27; x++) {
		//var v = (offset + x) % 360;
		ret.push({
		  x: x,
		  y: Math.floor(1300 - Math.random()*(1300-1100)),
		  //y: 5000,
		});
	  }
	  return ret;
